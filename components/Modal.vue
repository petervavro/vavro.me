        ...
        <div class="relative flex flex-col w-full h-full">
          <div class="overflow-y-auto relative grow shrink basis-auto">
            <div class="flex shrink-0 items-center justify-between p-5">
              <div></div>
              <div>
                <button @click="$emit('close')" class="border-primary border-2 p-3 text-primary" ref="target">
                  Close
                </button>
              </div>
            </div>
            ...
            <div class="w-full text-center pb-10">
              <button @click="$emit('close')" class="border-primary border-2 p-3 text-primary">
                Close
              </button>
            </div>
          </div>
