		...
		<div ref="target">
			<Transition>
				...
				>
					...
					<p>
						<strong>
							A Full-Stack Engineer, interested in programming
							since 1994.
						</strong>
						My main focus nowadays is in creating accessible digital
						experiences using JavaScript / Typescript. It is have
						been {{ getExperienceYears('javascript') }}+ years since
						I discovered JS and I feel comfortable in both, front
						and back end. My experience in front-end web and mobile:
