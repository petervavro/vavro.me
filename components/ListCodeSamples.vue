<template>
    <div class="grid grid-cols md:grid-cols-2 lg:grid-cols-3">
        <section v-for="item in items" :key="item.title" class="p-5 border-dotted border-t md:border-l border-primary">
            ...
            <div class="pt-3">
                <the-thumbnail v-bind="t" v-for="t in item.technologies" :key="t.id" class="p-3 inline-block" />
            </div>
        </section>
    </div>
</template>
